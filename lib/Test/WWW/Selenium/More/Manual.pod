package HHoldings::Core::Selenium::Manual;

=head1 NAME

HHoldings::Core::Selenium::Manual - Testing with Selenium


=head1 INSTALL THE SELENIUM SERVER

Selenium is written in Java.  So you need Java.  Then download the latest jar
file from http://seleniumhq.org/download.  Put it anywhere.
...
This section describes setting up and running Selenium tests on the command
line.
...
Also see the ENVIRONMENT VARIABLES section of HHoldings::Core::Selenium
documentation.


=head1 WRITING MORE ADVANCED TESTS
